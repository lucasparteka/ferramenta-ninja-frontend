			...
			left={
				<>
					...
					<div className="flex flex-1 flex-col p-3 space-y-3">
						...
						<div className="rounded-md border border-border bg-muted/40 px-3 py-2 font-mono text-caption text-muted-foreground tabular-nums leading-relaxed break-all">
							{formulaStr}
						</div>
					</div>
				</>
