...
import { textToBinary, binaryToText } from '@/lib/encoding/binary'
...
export function BinaryConverter() {
  ...
  function handleEncode() {
    ...
    try {
      ...
      setError(e instanceof Error ? e.message : 'Erro ao converter para binário.')
    }
  }
    ...
    <div className="flex flex-col gap-6 sm:flex-row">
      <div className="space-y-4 sm:flex-1">
        <div className="space-y-1">
          <label htmlFor="bin-input" className="flex w-full text-sm font-medium text-foreground">
            Texto de entrada
          </label>
          <textarea
            id="bin-input"
