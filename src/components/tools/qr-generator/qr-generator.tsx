    ...
    <div className="flex flex-col gap-6 sm:flex-row">
      <div className="space-y-4 sm:w-[30%] sm:shrink-0">
        <div className="space-y-1">
          <label htmlFor="qr-text" className="flex w-full text-sm font-medium text-foreground">
            Texto ou URL
          </label>
          <textarea
            id="qr-text"
        ...
        <div className="space-y-1">
          <label htmlFor="qr-size" className="flex w-full text-sm font-medium text-foreground">
            Tamanho
          </label>
          <select
            id="qr-size"
        ...
        <div className="space-y-1">
          <label htmlFor="qr-ecl" className="flex w-full text-sm font-medium text-foreground">
            Correção de erro
          </label>
          <select
            id="qr-ecl"
            value={state.errorCorrectionLevel}
            onChange={(e) => set('errorCorrectionLevel', e.target.value as ErrorCorrectionLevel)}
            className={selectClass}
          >
