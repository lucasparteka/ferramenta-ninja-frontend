		...
		tools: [
			{
				...
				description:
					"Conta caracteres, palavras, linhas e parágrafos em tempo real",
			},
			{
				name: "Conversor de Texto",
				href: "/ferramentas/conversor-de-texto",
				description:
					"Maiúsculo, minúsculo, capitalizar, inverter, remover acentos e espaços extras",
			},
			{
			...
			},
			{
				...
				description:
					"Converta texto para código Morse e código Morse para texto",
			},
			{
			...
			},
			{
				...
				description:
					"Converta arquivos CSV em PDF com tabela formatada, orientação automática e suporte a muitas colunas",
			},
			{
				name: "Converter CSV para SQL",
				href: "/ferramentas/converter-csv-para-sql",
				description:
					"Gere comandos SQL INSERT a partir de arquivos CSV, com suporte a MySQL, PostgreSQL, SQLite, Oracle e SQL Server",
			},
			{
				name: "Formatar Texto Para WhatsApp",
				href: "/ferramentas/formatador-de-texto-whatsapp",
				description:
					"Formate textos para envio no WhatsApp, com suporte a negrito, itálico, tachado e código",
			},
			{
				name: "Comparador de Textos",
				href: "/ferramentas/comparar-textos",
				description:
					"Compare dois textos e visualize as diferenças com destaque por cores",
			},
		],
	},
	{
		...
		tools: [
			...
			},
			{
				...
				description:
					"Gere números de cartão de crédito válidos para testes com Visa, Mastercard, Amex, Elo e Hipercard",
			},
			{
				name: "Validador de Cartão de Crédito",
				href: "/ferramentas/validador-de-cartao-de-credito",
				description:
					"Valide números de cartão de crédito pelo algoritmo de Luhn e identifique a bandeira automaticamente",
			},
		],
	},
	{
		...
		tools: [
			{
				...
				description:
					"5 calculadoras de porcentagem: valor, variação, desconto e aumento",
			},
			{
				name: "Calculadora de Adicional Noturno",
				href: "/ferramentas/calculadora-adicional-noturno",
				description:
					"Calcule o adicional noturno para empregados urbanos e rurais, com RSR/DSR",
			},
			{
				name: "Calculadora de Salário Líquido",
				href: "/ferramentas/calculadora-salario-liquido",
				description:
					"Calcule o salário líquido com desconto de INSS, IRRF e dependentes",
			},
		],
	},
	{
		...
		tools: [
			...
			},
			{
				...
				description:
					"Gere números aleatórios com intervalo, ordem e colunas personalizados",
			},
		],
	},
	{
		...
		tools: [
			...
			},
			{
				...
				description:
					"Gere UUIDs únicos nas versões v1, v3, v4 e v5 e valide UUIDs existentes",
			},
		],
	},
	{
		...
		tools: [
			{
				...
				description:
					"Desenhe livremente, crie formas e exporte imagens PNG direto no navegador",
			},
			{
				name: "Criador de Cartão Fidelidade",
				href: "/ferramentas/cartao-fidelidade",
				description:
					"Crie cartões fidelidade para imprimir com templates prontos para barbearia, cafeteria e mais",
			},
			{
				name: "Gerador de QR Code",
				href: "/ferramentas/gerador-de-qr-code",
				description:
					"Gere QR Codes a partir de qualquer texto ou URL e baixe em PNG",
			},
			{
				name: "Gerador de QR Code Wi-Fi",
				href: "/ferramentas/gerador-de-qr-code-wifi",
				description:
					"Gere QR Codes para conectar dispositivos à sua rede Wi-Fi automaticamente",
			},
			{
				name: "Gerador de QR Code Pix",
				href: "/ferramentas/gerador-de-qr-code-pix",
				description:
					"Gere QR Codes Pix estáticos para cobranças e pagamentos instantâneos",
			},
			{
				name: "Leitor de QR Code Online",
				href: "/ferramentas/leitor-de-qr-code",
				description:
					"Decodifique QR Codes a partir de imagens sem precisar de câmera",
			},
			{
				name: "Converter Imagem em Texto (OCR)",
				href: "/ferramentas/converter-imagem-em-texto",
				description:
					"Extraia texto de imagens, prints e documentos usando OCR no navegador",
			},
			{
				name: "Gerador de Código de Barras 1D",
				href: "/ferramentas/gerador-de-codigo-de-barras",
				description:
					"Gere códigos de barras EAN-13, CODE 128, UPC e outros em SVG",
			},
			{
				name: "Gerador de Código de Barras em Lote",
				href: "/ferramentas/gerador-de-codigo-de-barras-em-lote",
				description:
					"Gere vários códigos de barras de uma vez a partir de uma lista de valores",
			},
		],
	},
	{
		...
		tools: [
			{
				...
				description:
					"Monte seu currículo com templates modernos e baixe em PDF gratuitamente",
			},
		],
	},
	{
		...
		tools: [
			...
			},
			{
				...
				description:
					"Reduza o tamanho de arquivos PDF e veja a diferença antes de baixar",
			},
		],
	},
	{
		...
		tools: [
			{
				...
				description:
					"Copie emojis com um clique — rostos, animais, comida e muito mais",
			},
			{
				name: "Emoticons para Copiar",
				href: "/ferramentas/emoticons",
				description:
					"Copie emoticons de texto com um clique — clássicos e kaomoji",
			},
			{
				name: "Símbolos para Copiar",
				href: "/ferramentas/simbolos",
				description:
					"Copie símbolos especiais — matemática, setas, moedas e formas",
			},
		],
	},
];
				...
				<div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
					<div className="mx-auto max-w-3xl text-center">
						...
						<p className="mt-6 text-lg text-muted-foreground">
							Acesse dezenas de ferramentas para desenvolvedores e
							profissionais. Sem cadastro, sem instalação, direto no navegador.
						</p>
					</div>
				</div>
			</section>
