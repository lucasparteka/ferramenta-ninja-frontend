...
import { Upload, X, ArrowUpDown, ArrowUp, ArrowDown, ChevronLeft, ChevronRight } from 'lucide-react'
...
export function CsvViewer() {
  ...
  function handlePreview() {
    ...
    setState('error')
    setErrorMsg('Selecione um arquivo ou cole o conteúdo CSV antes de visualizar.')
  }
    ...
    <div className="space-y-4">
      ...
      {skippedRows > 0 && state === 'done' && (
        <p aria-live="polite" className="text-sm text-warning">
          {skippedRows} {skippedRows === 1 ? 'linha ignorada' : 'linhas ignoradas'} por ter número
          de colunas diferente do cabeçalho.
        </p>
      )}
          ...
          <div className="flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between">
            <p className="text-sm text-muted-foreground">
              ...
              {parsed.rows.length > 10000 && (
                <span className="ml-2 text-warning">(arquivo grande — desempenho pode variar)</span>
              )}
            </p>
