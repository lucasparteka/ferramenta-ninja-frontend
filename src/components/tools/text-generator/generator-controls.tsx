  ...
  return (
    <div className="grid gap-4 sm:grid-cols-3">
      <div className="space-y-2">
        <label htmlFor="generator-type" className="text-sm font-medium text-foreground">
          Tipo de texto
        </label>
        <select
          id="generator-type"
      ...
      <div className="space-y-2">
        <label htmlFor="generator-quantity" className="text-sm font-medium text-foreground">
          Quantidade
        </label>
        <input
      ...
      <div className="space-y-2">
        <label htmlFor="generator-unit" className="text-sm font-medium text-foreground">
          Formato
        </label>
        <select
          id="generator-unit"
