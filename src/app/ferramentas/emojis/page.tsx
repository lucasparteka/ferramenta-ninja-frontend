...
export default function EmojisPage() {
  return (
    <PageLayout
      ...
      extraContent={
        <section>
          <h2 className="mb-4 text-xl font-bold text-foreground">Sobre os emojis</h2>
          <p>
            Os emojis são caracteres Unicode padronizados e funcionam em qualquer plataforma:
            WhatsApp, Instagram, Twitter, e-mail, documentos e muito mais. Clique para copiar e
            cole onde quiser.
          </p>
        </section>
      }
