...
export default function EmoticonsPage() {
  return (
    <PageLayout
      ...
      extraContent={
        <section>
          <h2 className="mb-4 text-xl font-bold text-foreground">Sobre os emoticons</h2>
          <p>
            Emoticons são representações de expressões faciais e gestos feitas com caracteres de
            texto. Diferente dos emojis, funcionam em qualquer sistema que exiba texto puro,
            incluindo terminais, e-mails antigos e sistemas sem suporte a Unicode estendido.
          </p>
        </section>
      }
    >
