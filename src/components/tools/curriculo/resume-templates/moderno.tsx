...
export function ModernoTemplate({
	...
	return (
		...
		>
			<div
				className="border-b-[3px] pb-5 mb-6"
			...
			>
				<div className="flex items-start justify-between gap-4">
					<div className="flex-1 min-w-0">
						...
						{data.headline && (
							<p
								className="text-base font-semibold mt-2 uppercase tracking-wide"
							...
							{data.experiences!.map((exp, i) => (
								<div key={i} className="pdf-item">
									<div className="flex items-start justify-between gap-4">
										...
										<p
											className="text-sm font-medium shrink-0 mt-0.5 whitespace-nowrap"
											style={{ color: "var(--accent)" }}
										>
