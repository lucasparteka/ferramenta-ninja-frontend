...
export function RandomPicker() {
  ...
  return (
    <div className="space-y-6">
      <RandomPickerInput value={input} onChange={handleInput} itemCount={items.length} />
      <RandomPickerOptions options={options} maxWinners={maxWinners} onChange={setOptions} />
