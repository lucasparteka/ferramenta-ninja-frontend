...
export function PasswordOutput({ password, onCopy, copied }: PasswordOutputProps) {
  return (
    <div className="space-y-2">
      <label htmlFor="password-output" className="text-sm font-medium text-foreground">
        Senha gerada
      </label>
      <div className="flex gap-2">
        ...
        />
        <Button variant="outline" onClick={onCopy} disabled={!password} aria-label="Copiar senha">
