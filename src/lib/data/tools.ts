...
export const categories: ToolCategory[] = [
  ...
  },
  {
    ...
    tools: [
    {
      ...
      description: "Crie currículos profissionais prontos para impressão em PDF",
      icon: FileText, 
    ...
    },
    {
      ...
      description: "Crie cardápios personalizados prontos para impressão em PDF",
      icon: SquareMenu, 
    ...
    },
    {
      ...
      description: "Crie cartões de fidelidade personalizados prontos para impressão em PDF",
      icon: Star, 
    ...
    },
    {
      ...
      description: "Crie assinaturas de email profissionais com templates e exportação HTML",
      icon: Mail, 
  ...
  },
  {
    ...
    },
    {
      ...
      href: "/ferramentas/calcular-horas-trabalhadas",
      description: "Horas por dia, semana e mês com entrada, saída e intervalo",
      icon: Timer, 
      tags: ["calculo","trabalhista","ponto","hora extra"],
      intent: "analyze",
    },
    {
    ...
    },
    {
      ...
      description: "Calcule dias úteis entre datas com feriados nacionais brasileiros",
      icon: CalendarCheck2, 
  ...
  },
  {
    ...
    },
    {
      ...
      description: "QR codes com cores, estilos, logo central e múltiplos tipos de conteúdo",
      icon: QrCode, 
  ...
  },
  {
    ...
    },
    {
      ...
      description: "Converta Markdown para HTML com preview em tempo real e exportação",
      icon: Code, 
