...
export function LayoutC({ left, right, toolbar, footer, swapButton }: LayoutCProps) {
	return (
		<div className="rounded-sm border border-border overflow-hidden flex flex-col">
			{toolbar && (
				<div className="flex items-center justify-between border-b border-border bg-card px-3 py-2.5 gap-3">
					{toolbar}
				</div>
			)}
			<div className="relative grid grid-cols-1 md:grid-cols-2">
				<div className="flex flex-col border-b border-border md:border-b-0 md:border-r border-border">
					{left}
				</div>
