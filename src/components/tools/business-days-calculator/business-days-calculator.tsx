		 ...
		 <div className="space-y-6">
			 ...
			 <div className="max-w-2xl space-y-4">
				 ...
				 <div className="flex items-center gap-2">
					 ...
					 >
						 Contabilizar feriados facultativos (Dia do Servidor Público,
						 Véspera de Natal, Véspera de Ano-Novo)
					 </label>
				 </div>
				 ...
				 <div className="flex flex-wrap gap-2">
					 <Button
						 onClick={
							 mode === "range" ? handleCalculateRange : handleAddDays
						 }
			 ...
			 {result?.range && (
				 <div className="max-w-2xl space-y-4">
					 <ResultGrid>
						 ...
						 <ResultRow
							 label="Feriados"
							 value={result.range.holidayDays}
						 />
					 </ResultGrid>
