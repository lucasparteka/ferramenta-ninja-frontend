...
export const RESUME_MOCK_DATA: ResumeTemplateData = {
  ...
  experiences: [
    ...
    },
    {
      ...
      company: "Grupo Comercial Litoral",
      location: "São José, SC",
      startDate: "2017-01",
      endDate: "2018-07",
      isCurrent: false,
      description:
        "Apoio na criação de materiais gráficos e gestão de redes sociais.\nMonitoramento de métricas de engajamento e elaboração de relatórios mensais.",
    },
  ],
  education: [
    {
    ...
    {
      institution: "ESPM Sul",
      degree: "Pós-graduação",
      field: "Marketing Digital e E-commerce",
      startYear: "2019",
      endYear: "2020",
      isCurrent: false,
      description: "",
