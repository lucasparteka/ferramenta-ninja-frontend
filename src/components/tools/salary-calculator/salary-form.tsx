...
export function SalaryCalculatorForm(props: SalaryCalculatorFormProps) {
  ...
  function onSubmit(data: SalaryFormValues) {
    ...
    const result = calculateSalary({ grossSalary, benefits, dependents, otherDiscounts })
                ...
                <div className="flex items-center justify-between">
                  ...
                  <Popover>
                    ...
                    <PopoverContent className="w-60 text-sm">
                      Valor total do salário antes dos descontos de INSS, IRRF e outros. É o valor
                      do salário assinado em carteira.
                    </PopoverContent>
                  </Popover>
                </div>
                <FormControl>
              ...
              <FormItem>
                <div className="flex items-center justify-between">
                  ...
                  <Popover>
                    ...
                    <PopoverContent className="w-60 text-sm">
                      Dependentes legais do trabalhador. Usados para cálculo de benefícios do
                      imposto de renda.
                    </PopoverContent>
                  </Popover>
                </div>
              ...
              <FormItem>
                <div className="flex items-center justify-between">
                  ...
                  <Popover>
                    ...
                    <PopoverContent className="w-60 text-sm">
                      Informe valores como vale-transporte, empréstimos, pensões ou contribuições
                      adicionais.
                    </PopoverContent>
                  </Popover>
                </div>
              ...
              <FormItem>
                <div className="flex items-center justify-between">
                  ...
                  <Popover>
                    ...
                    <PopoverContent className="w-60 text-sm">
                      Inclua valores extras além do salário bruto, como vale-alimentação, bônus,
