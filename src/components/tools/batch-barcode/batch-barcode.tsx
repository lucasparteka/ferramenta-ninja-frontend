...
function BarcodeItem({ value, format, displayValue }: BarcodeEntry) {
  ...
  return (
    <div className="flex flex-col items-center gap-2 rounded-lg border border-border bg-card p-3">
      ...
      <p className="max-w-full truncate text-center text-xs text-muted-foreground" title={value}>
        {value}
      </p>
      {!error && (
    ...
    <div className="flex flex-col gap-6 sm:flex-row">
      <div className="space-y-4 sm:w-[30%] sm:shrink-0">
        <div className="space-y-1">
          <label htmlFor="batch-format" className="flex w-full text-sm font-medium text-foreground">
            Formato
          </label>
          <select
            id="batch-format"
        ...
        <div className="space-y-1">
          <label htmlFor="batch-values" className="flex w-full text-sm font-medium text-foreground">
