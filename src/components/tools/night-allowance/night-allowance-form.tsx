                  ...
                  <div className="flex items-center justify-between">
                    ...
                    <Popover>
                      ...
                      <PopoverContent className="w-60 text-sm">
                        Valor total do salário antes de quaisquer descontos. É o valor do salário
                ...
                <FormItem>
                  <div className="flex items-center justify-between">
                    ...
                    <Popover>
                      ...
                      <PopoverContent className="w-60 text-sm">
                        Total de horas mensais contratadas. O padrão é 220 horas por mês (8h por
                        dia, 44h por semana).
                      </PopoverContent>
                    </Popover>
                  </div>
                ...
                <FormItem>
                  <div className="flex items-center justify-between">
                    ...
                    <Popover>
                      ...
                      <PopoverContent className="w-60 text-sm">
                        Selecione se as horas informadas já são noturnas ou se são diurnas que
                ...
                <FormItem>
                  <div className="flex items-center justify-between">
                    ...
                    <Popover>
                      ...
                      <PopoverContent className="w-60 text-sm">
                        Total de horas trabalhadas no período a ser convertido em horas noturnas,
                        se aplicável.
                      </PopoverContent>
                    </Popover>
                  </div>
                ...
                <FormItem>
                  <div className="flex items-center justify-between">
                    ...
                    <Popover>
                      ...
                      <PopoverContent className="w-60 text-sm">
                        Total de dias úteis no mês, excluindo fins de semana e feriados.
                      </PopoverContent>
                    </Popover>
                  </div>
                  <FormControl>
                ...
                <FormItem>
                  <div className="flex items-center justify-between">
                    ...
                    <Popover>
                      ...
                      <PopoverContent className="w-60 text-sm">
                        Quantidade de domingos e feriados no mês para cálculo de RSR/DSR.
                      </PopoverContent>
                    </Popover>
                  </div>
                  <FormControl>
                ...
                <FormItem>
                  <div className="flex items-center justify-between">
                    ...
                    <Popover>
                      ...
                      <PopoverContent className="w-60 text-sm">
                        Trabalhadores rurais têm direito a adicional noturno de 25%. Urbanos
                        recebem 20%. Selecione conforme o caso.
                      </PopoverContent>
                    </Popover>
                  </div>
                  <FormControl>
                ...
                <FormItem>
                  <div className="flex items-center justify-between">
                    ...
                    <Popover>
                      ...
                      <PopoverContent className="w-60 text-sm">
                        Percentual do adicional noturno. Urbano: 20%, Rural: 25%. Esse valor será
                        aplicado sobre o valor da hora.
                      </PopoverContent>
                    </Popover>
                  </div>
                  <FormControl>
