...
export default function SimbolosPage() {
  return (
    <PageLayout
      ...
      extraContent={
        <section>
          <h2 className="mb-4 text-xl font-bold text-foreground">Sobre os símbolos</h2>
          <p>
            Todos os símbolos desta página são caracteres Unicode e funcionam em qualquer
            plataforma que suporte texto — documentos, planilhas, e-mails, sites e aplicativos.
            Úteis para matemática, design, tipografia e comunicação.
          </p>
        </section>
      }
    >
      <CopyGrid categories={symbolCategories} itemClass="h-12 w-12 text-xl font-mono" />
    </PageLayout>
  )
}
