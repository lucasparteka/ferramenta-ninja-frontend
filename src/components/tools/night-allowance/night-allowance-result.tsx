    ...
    <div className="w-full lg:w-1/2 bg-gray-50 p-6 rounded-md border border-gray-200">
      ...
      {hasResult && (
        <div className="space-y-6">
          <div>
            <h3 className="font-semibold text-gray-800 mb-3">Dados informados</h3>
            <div className="space-y-2 text-sm">
              ...
              <div className="flex justify-between">
                <span className="text-gray-600">Percentual do adicional noturno:</span>
          ...
          <div className="border-t border-gray-200 pt-6">
            ...
            <div className="space-y-2 text-sm">
              ...
              <div className="flex justify-between">
                <span className="text-gray-600">Horas noturnas trabalhadas:</span>
                <span className="font-medium">{formatHours(nightHoursWorked)}</span>
              </div>
              <div className="flex justify-between">
                <span className="text-gray-600">Valor do adicional por hora:</span>
                <span className="font-medium">{formatCurrency(allowanceValue)}</span>
              </div>
              <div className="flex justify-between">
                <span className="text-gray-600">Hora com adicional:</span>
                <span className="font-medium">{formatCurrency(hourWithAllowance)}</span>
              </div>
              <div className="flex justify-between">
          ...
          <div className="flex justify-between items-center border-t border-gray-200 pt-4 mt-2">
            <span className="text-lg font-bold text-gray-800">Total do adicional devido:</span>
