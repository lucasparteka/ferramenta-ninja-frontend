...
export function RemoveDuplicatesOutput({ value, onCopy, copied }: RemoveDuplicatesOutputProps) {
  return (
    <div className="space-y-2">
      <div className="flex items-center justify-between">
        <label htmlFor="duplicates-output" className="text-sm font-medium text-foreground">
          Resultado
        </label>
      ...
      <textarea
        ...
        readOnly
        value={value}
        placeholder='Clique em "Remover duplicados" para processar...'
        rows={10}
