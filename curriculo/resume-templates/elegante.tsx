  ...
  return (
    <section className="section">
      <div className="flex items-center gap-3 mb-3">
        ...
        <div className="flex-1 h-px opacity-40" style={{ backgroundColor: "var(--accent)" }} />
      </div>
      {children}
    </section>
  );
    ...
    >
      <div className="flex items-start justify-between gap-6 mb-7">
        ...
        <div className="text-right">
          <h1 className="text-2xl font-semibold leading-tight tracking-tight">{data.name}</h1>
          {data.headline && (
            ...
            <div className="space-y-5">
              {data.experiences!.map((exp, i) => (
                <div key={i} className="pdf-item flex items-start justify-between gap-4">
                  ...
                  <p className="text-sm shrink-0 mt-1 whitespace-nowrap text-right font-medium" style={{ color: "var(--accent)" }}>
            ...
            <div className="space-y-4">
              {data.education!.map((edu, i) => (
                <div key={i} className="pdf-item flex items-start justify-between gap-4">
                  ...
                  <p className="text-sm shrink-0 whitespace-nowrap text-right font-medium" style={{ color: "var(--accent)" }}>
                ...
                <div className="flex-1 space-y-2">
                  {data.skills!.map((s, i) => (
                    <div key={i} className="flex items-center gap-2">
                      <div className="w-px h-4 shrink-0" style={{ backgroundColor: "var(--accent)" }} />
                      {s.name}
                    </div>
                  ))}
                </div>
